            ...
            <div class="hero">
                ...
                <div class="hero__slider swiper-container">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        if( have_rows('swiper_tab') ):


                        while ( have_rows('swiper_tab') ) : the_row(); ?>

                        <!-- hero__slide -->
                        <section class="hero__slide swiper-slide">

                            <div class="hero__slide-picture">
                                <img src="<?php the_sub_field('image_swiper');  ?>" alt="img" />
                            </div>
                            ...
                            <div class="hero__slide-layout">
                                ...
                                <div class="hero__slide-text article">
                                    ...
                                    <h2><?php the_sub_field('swiper_title');  ?></h2>

                                    <p><?php the_sub_field('description_swiper');  ?></p>

                                </div>
                                <?php if(get_sub_field ('select_button') ==='default' ) { ?>

                                    <div class="hero__slide-btn-wrap">
                                        <?php $linkPage = get_sub_field ( 'link_button');
                                        ?>
                                        <a href="<?php the_permalink($linkPage);?>" class="btn btn_color-1 btn_type-general"><span><?php the_sub_field('click_button_swiper');  ?></span></a>
                                ...
                                <?php } else { ?>
                                    ...
                                    <div class="hero__slide-btn-wrap">
                                        ...
                                        <a href="#" class="hero__link"><span><?php the_sub_field('click_button_swiper');  ?></span></a>
