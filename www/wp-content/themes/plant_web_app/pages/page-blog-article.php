<?php //Template Name: Page blog-article
get_header();
?>
<!-- site__content -->
<div class="site__content">
    ...
    <div class="blog-thumbnail js-back-picture">
        <img src="pic/img-007.jpg" alt="img"/>
    </div>
    <!-- /blog-thumbnail -->
    ...
    <div class="site__wrap">
        ...
        <div class="site__content-wrap">
            ...
            <div class="blog-article article">
                ...
                <h1>A Vegan Thanksgiving Feast</h1>

                <p><strong>1. Learn New Recipes</strong></p>

                <p>The first and most obvious thing you want to do is to learn new recipes. That may mean that you buy new ingredients that you’ve never bought before. Oh no! You’re treading in to unchartered waters here :).</p>

                <p>There are so many recipes that you can find for free around the internet that will give you inspiration and give you more variety. Try them out and as you try more of these recipes out, you will gain more confidence is doing more. Adding to the variety of your current diet. Here are all of our free recipes.</p>

                <p>Also make sure to try and modify recipes using different foods where you see fit. This makes it so much more fun! Cooking should have an element of excitement to it so be creative :).</p>
                ...
                <p><strong>2. Learn New Cultures Of Food</strong></p>

                <p>My second tip is to try out new cultures of food. Whether it’s Mexican, Korean or Indian, try it out! You will never know what flavors you will end up loving if you don’t try something new.</p>

                <p>Different cultures use a different set of flavors and spices so you will surely experience some new tastes that just may become your next favorite.</p>

                <p><strong>3. Don’t Deem Plant-based Fats As Being Bad</strong></p>

                <p>In the high-carb plant-based community, plant-based fats can be deemed as detrimental to your health. Including some plant-based fats in moderation is definitely and should be included. Foods like avocados, tahini, nuts and seed are great examples.When you include these foods you’ll have tasty satisfying food that will surely add to the variety of what you normally eat.</p>

                <p><strong>4. Watch ‘Cook With Me’ Videos</strong></p>

                <p>I think that watching ‘Cook With Me’ videos are a great way to learn how different foods and flavors work together. Check these videos wherever you find them. I’ve listed two excellent YouTube channels below where you can find these types of videos often.</p>
