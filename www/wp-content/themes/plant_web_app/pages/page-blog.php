...
<div class="site__content">
    ...
    <div class="hero-article">
        ...
        <div class="hero-article__wrap article">
            ...
            <h1>My Blog & Stories</h1>

            <p>This blog is all about inspiration and motivation for those of you who are ready for change now. Here you'll find the most recent updates, stories from real people who have experienced tremendous changes from following my weight loss plan and also what the media is saying about what I'm doing.</p>

        </div>

        <div class="hero-article__back js-back-picture">
            <img src="img/blog-hero-back.jpg" alt="img" />
        </div>
