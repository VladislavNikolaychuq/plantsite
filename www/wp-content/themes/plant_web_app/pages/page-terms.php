    ...
    <div class="site__wrap">
        ...
        <div class="site__content-wrap">
            ...
            <div class="blog-article article">
                ...
                <h1>HCH Terms and Conditions</h1>
                ...
                <p><strong>A. INTRODUCTION TO OUR SERVICES</strong></p>
                ...
                <p><strong>B. USING OUR SERVICES</strong></p>

                <p><strong>PAYMENTS, TAXES, AND REFUNDS</strong></p>
                ...
                <p>Your use of our Services is subject to Apple’s Privacy Policy, which is available at <a href="https://www.apple.com/legal/privacy/" target="_blank" rel="nofollow">https://www.apple.com/legal/privacy/</a></p>
        ...
        <aside class="site__aside top-null">
            ...
            <section class="app-promo">
                ...
                <div class="app-promo__picture">
                    <img src="img/app-promo.jpg" alt="img" />
                </div>

                <div class="app-promo__layout">

                    <div class="app-promo__text article">

                        <h2>Lose weight with Meal Plans App</h2>

                        <p>Change yourself for the better. Our application will help you tidy up a delicious and healthy diet, monitor progress.</p>

                    </div>

                    <a class="app-promo__download" href="#" rel="nofollow" target="_blank">
            ...
            <section class="success-stories">
                ...
                <h2 class="success-stories__title">Top Inspiring Stories</h2>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="success-stories__slide swiper-slide">
                            ...
                            <div class="success-stories__slide-picture">
                                <img src="pic/success-stories-001.png" alt="img" />
                            </div>

                            <dl class="success-stories__slide-text">

                                <dt>Rebecca Cietto</dt>

                                <dd>
                                    <p>"Thank You! It really saves me time and effort. book is exactly what our business has been lacking. It really saves me time and effort. book is exactly what our business has been lacking. I would gladly pay over 600 dollars for book."</p>
                                </dd>
